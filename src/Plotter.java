...
public class Plotter extends ApplicationFrame {
    ...
    public Plotter(ArrayList<Double> bests, ArrayList<Double> worsts, ArrayList<Double> avgs) {
    ...
    private XYDataset createData(ArrayList<Double> bests, ArrayList<Double> worsts, ArrayList<Double> avgs) {
